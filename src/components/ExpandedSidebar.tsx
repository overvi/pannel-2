...
const activeClassNames = ["bg-orange-400", "p-2", "rounded-full"];

type ActiveSection = "notifications" | "management";

const ExpandedSidebar = ({ active }: { active: ActiveSection }) => {
  ...
  return (
    <div className={`${en ? "me-56" : "ml-56"}`}>
      <div className="bg-white h-[33rem] fixed mt-3 flex dark:bg-gray-900  dark:text-white dark:border-gray-500 rounded-3xl">
        <div className="flex space-y-3 flex-col pt-16 rounded-full p-2 shadow-md gap-7 items-center ">
          <a
            href="/account"
            className={active == "management" ? activeClassNames.join(" ") : ""}
          >
            <svg
              width="32"
              height="32"
          ...
          <a
            href="/messages"
            className={
              active == "notifications" ? activeClassNames.join(" ") : ""
            }
          >
            <svg
              width="32"
        ...
        <div className=" space-y-4 mt-16 p-4 w-[11rem] flex flex-col gap-8 font-bold  pr-5">
          <div dir={en ? "rtl" : "ltr"}>
