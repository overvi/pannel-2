    ...
    <header>
      <nav className="p-4 justify-between flex gap-3 items-center ">
        <div className="flex  items-center gap-3">
          <Popover
            content={
              <div
                dir="ltr"
                className="font-yekan w-[25rem] p-2 pb-20 rounded-full "
              >
                <div>
                  <h1 className="font-bold text-lg border-b  pb-3">Database</h1>
          ...
          <div className="bg-white dark:bg-gray-900 z-0 relative overflow-hidden pr-3 rounded-full w-[27rem] h-[2.875rem]">
            <input
              ...
              className="w-full h-full dark:bg-gray-900 ml-14 dark:text-white max-w-[20rem] pr-3 absolute z-[1] top-0 shadow-none outline-none border-none"
            />
          ...
          <Popover
            content={
              <div dir="ltr" className="font-yekan w-[25rem] p-2 rounded-full ">
                <div>
                  <h1 className="font-bold text-lg  pb-3">Favourites </h1>
              ...
              <div dir="ltr" className="font-yekan w-[25rem] p-2 rounded-full ">
                <div>
                  ...
                  <div className="mt-2 border-t py-3 ">
                    <div>
                      <h2 className="font-bold"> Contact Ways </h2>
                  ...
                  <div className="mt-2  py-3 ">
                    <div>
                      <h2 className="font-bold">Work Hours </h2>
                      <p className="mt-2">From 8pm To 12Am</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Popover
            content={
              <div dir="ltr" className="font-yekan w-[20rem] rounded-full ">
                <div dir="ltr" className="border-b pb-3 p-2">
                  <h1 className="font-bold text-lg">Account Details </h1>
                  <p>gxgrsadas8344</p>
                </div>
                <div dir="ltr" className="border-b py-3">
                  <h1 className="font-bold text-lg"> Amount</h1>
                  <p>1200.USD</p>
                </div>
                <div dir="ltr" className="py-3">
                  <h1 className="font-bold text-lg"> Customer Informations </h1>
                  <p>Hjys</p>
                </div>
                <div className="mt-3 flex items-center gap-7" dir="ltr">
                  <button className="flex flex-col justify-center items-center">
                    ...
                    <p className="text-center"> Exit </p>
                  </button>
                  <button className="flex flex-col justify-center items-center">
                    <div className="rounded-full w-fit p-2 bg-gray-50 dark:bg-gray-900">
                      <svg
          ...
          >
            <div
              tabIndex={0}
              className="rounded-full pl-5 cursor-pointer flex items-center gap-2 p-1 bg-white dark:bg-gray-900 w-fit "
            >
              <p className="dark:text-white px-3">780 </p>
